...
class union_map(object):
    ...
    def card(arg0):
        try:
            ...
            raise
        ctx = arg0.ctx
        res = isl.isl_union_map_card(isl.isl_union_map_copy(arg0.ptr))
        obj = union_pw_qpolynomial(ctx=ctx, ptr=res)
        return obj
    def coalesce(arg0):
        try:
            if not arg0.__class__ is union_map:
...
isl.isl_union_map_card.argtypes = [c_void_p]
...
class map(union_map):
    ...
    def card(arg0):
        try:
            ...
            raise
        ctx = arg0.ctx
        res = isl.isl_map_card(isl.isl_map_copy(arg0.ptr))
        obj = pw_qpolynomial(ctx=ctx, ptr=res)
        return obj
    def coalesce(arg0):
        try:
            if not arg0.__class__ is map:
...
isl.isl_map_card.argtypes = [c_void_p]
...
class basic_map(map):
    ...
    def card(arg0):
        try:
            ...
            raise
        ctx = arg0.ctx
        res = isl.isl_basic_map_card(isl.isl_basic_map_copy(arg0.ptr))
        obj = pw_qpolynomial(ctx=ctx, ptr=res)
        return obj
    def deltas(arg0):
        try:
...
isl.isl_basic_map_card.argtypes = [c_void_p]
...
class union_set(object):
    ...
    def card(arg0):
        try:
            ...
            raise
        ctx = arg0.ctx
        res = isl.isl_union_set_card(isl.isl_union_set_copy(arg0.ptr))
        obj = union_pw_qpolynomial(ctx=ctx, ptr=res)
        return obj
    def coalesce(arg0):
        try:
...
isl.isl_union_set_card.argtypes = [c_void_p]
...
class set(union_set):
    ...
    def card(arg0):
        try:
            ...
            raise
        ctx = arg0.ctx
        res = isl.isl_set_card(isl.isl_set_copy(arg0.ptr))
        obj = pw_qpolynomial(ctx=ctx, ptr=res)
        return obj
    def coalesce(arg0):
        try:
...
isl.isl_set_card.argtypes = [c_void_p]
...
class basic_set(set):
    ...
    def card(arg0):
        try:
            ...
            raise
        ctx = arg0.ctx
        res = isl.isl_basic_set_card(isl.isl_basic_set_copy(arg0.ptr))
        obj = pw_qpolynomial(ctx=ctx, ptr=res)
        return obj
    def detect_equalities(arg0):
        try:
...
isl.isl_basic_set_card.argtypes = [c_void_p]
...
class pw_qpolynomial(object):
    ...
    def sum(arg0):
        try:
            ...
            raise
        ctx = arg0.ctx
        res = isl.isl_pw_qpolynomial_sum(isl.isl_pw_qpolynomial_copy(arg0.ptr))
        obj = pw_qpolynomial(ctx=ctx, ptr=res)
        return obj
...
isl.isl_pw_qpolynomial_sum.restype = c_void_p
isl.isl_pw_qpolynomial_sum.argtypes = [c_void_p]
...
class union_pw_qpolynomial(object):
    ...
    def sum(arg0):
        try:
            ...
            raise
        ctx = arg0.ctx
        res = isl.isl_union_pw_qpolynomial_sum(isl.isl_union_pw_qpolynomial_copy(arg0.ptr))
        obj = union_pw_qpolynomial(ctx=ctx, ptr=res)
        return obj
...
isl.isl_union_pw_qpolynomial_sum.restype = c_void_p
isl.isl_union_pw_qpolynomial_sum.argtypes = [c_void_p]
